<script lang="ts">
    ...
    const images = [
        ...
        { src: roller_2, alt: "Esteban Kroh, clases de roller hockey para adultos.", text: "El compromiso hace al crecimiento." },
        { src: roller_3, alt: "Esteban Kroh, clases de rollers para niños.", text: "El futuro, lo creamos nosotros." }
    ];
    let current = 0;
    let interval: number;
...
<div class="relative max-w-2xl mx-auto overflow-hidden">
    <div class="relative w-full h-0 pb-[70%]">
        ...
        <div class={`absolute inset-0 transition-opacity duration-1000 ${i === current ? 'opacity-100' : 'opacity-0'}`}>
